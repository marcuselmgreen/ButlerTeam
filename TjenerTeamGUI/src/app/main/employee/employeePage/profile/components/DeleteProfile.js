...
class DeleteProfile extends Component {
    ...
    deleteEmpHandler = (e) => {
        let tempState = {...this.state.editEmployee};
        tempState[e.target.name] = e.target.value;
        this.setState({editEmployee: tempState})
    };
    ...
    render() {
        const {showDeleteModal, editEmployee} = this.state;
                        ...
                        <Card className="p-32">
                            ...
                            <div>
                                <TextField
                                    ...
                                    value={editEmployee.userDeleteConfirm}
                                    label="Bekræftelse"
                                    className="w-full"
                                    variant="outlined"
                                    onChange={(e) => this.deleteEmpHandler(e)}
                                />
                            </div>
                            <div className="flex justify-center my-2 ">
                                <div className="w-1/2 p-4">
                                    <Button
                                        disabled={editEmployee.userDeleteConfirm !== 'slet'}
                                        color="primary"
                                        variant="contained"
